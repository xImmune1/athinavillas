    ...
    <main className="bg-background">
      ...
      <section className="bg-primary text-[oklch(0.97_0.012_85)] py-24 md:py-32 px-6 md:px-16 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Link to="/book" className="bg-[oklch(0.97_0.012_85)] text-primary px-10 py-4 text-xs uppercase tracking-[0.3em] hover:bg-accent hover:text-accent-foreground transition">
            Book your stay
          </Link>
        </div>
      </section>
