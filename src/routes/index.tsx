...
function Nav() {
  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-30 px-6 md:px-12 py-6 flex items-center justify-between text-[oklch(0.97_0.012_85)]">
      <a href="#top" className="font-serif text-2xl tracking-wide">Athina<span className="text-accent"> · </span>Villas</a>
      <ul className="hidden md:flex items-center gap-8 text-sm uppercase tracking-[0.18em] font-light">
        {links.map(([l, h]) => (
          <li key={l}><a href={h} className="opacity-80 hover:opacity-100 transition">{l}</a></li>
        ))}
      </ul>
      <a
        href="#book"
        className="hidden md:inline-block border border-[oklch(0.97_0.012_85/0.5)] px-5 py-2 text-xs uppercase tracking-[0.2em] hover:bg-[oklch(0.97_0.012_85)] hover:text-primary transition"
      >
        Book
      </a>
    </nav>
    ...
    <section id="top" className="relative h-screen min-h-[680px] w-full overflow-hidden bg-primary">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end px-6 md:px-16 pb-24 md:pb-32 text-[oklch(0.97_0.012_85)]">
        ...
        <div className="mt-10 flex flex-wrap gap-4 animate-fadeup delay-600">
          <a
            href="#book"
            className="bg-[oklch(0.97_0.012_85)] text-primary px-8 py-4 text-xs uppercase tracking-[0.25em] hover:bg-accent hover:text-primary-foreground transition"
          >
            Book Your Stay
          </a>
          <a
            href="#rooms"
            className="border border-[oklch(0.97_0.012_85/0.7)] px-8 py-4 text-xs uppercase tracking-[0.25em] hover:bg-[oklch(0.97_0.012_85/0.1)] transition"
          >
            Explore Rooms
          </a>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 text-[oklch(0.97_0.012_85)] text-[10px] uppercase tracking-[0.4em] opacity-70 animate-fadeup delay-800">
        Scroll ↓
      </div>
    </section>
  );
    ...
    <section className="py-24 md:py-40 px-6 md:px-16 max-w-7xl mx-auto">
      <div className="grid md:grid-cols-12 gap-12 md:gap-20 items-center">
        ...
        <div className="md:col-span-7 space-y-6 text-base md:text-lg leading-relaxed text-muted-foreground">
          <p>
            Athina Villas is tucked into the fishing village of Plaka, in
            Lassithi — directly across the bay from Spinalonga and just one
            hundred metres from the pebbled shore. Each apartment is finished
            with a well-equipped kitchenette, soft linens, and Wi-Fi that
            simply works.
          </p>
          <p>
            A few steps from your door: a mini market, family taverns, the bus
            stop, and the small port where the boats leave for Spinalonga.
            Parking, like the morning light, is free.
          </p>
...
function Rooms() {
  const rooms = [
    { img: studioImg, size: "30 m²", guests: "2 Guests", name: "Studio", tag: "Intimate retreat for two" },
    { img: gardenImg, size: "50 m²", guests: "4 Guests", name: "Garden View", tag: "Lush seclusion with garden panorama" },
    { img: seaImg, size: "90 m²", guests: "4–5 Guests", name: "Sea View", tag: "Spinalonga & the Cretan Sea at your feet" },
  ];
  return (
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-16 md:mb-24 gap-6">
          ...
          <p className="max-w-md text-base md:text-lg opacity-80 leading-relaxed">
            From intimate studios to panoramic sea-view apartments — each space
            designed for the slow, sun-soaked Cretan way of living.
          </p>
        </div>
...
function Spinalonga() {
  return (
    <section id="facilities" className="relative h-[80vh] min-h-[520px] overflow-hidden">
      <img
        src={spinalongaImg}
        alt="Spinalonga island fortress across the bay from Plaka"
        loading="lazy"
        width={1920}
        height={1100}
      ...
      <div className="relative z-10 h-full flex items-center px-6 md:px-16 max-w-7xl mx-auto">
        <div className="max-w-xl text-[oklch(0.97_0.012_85)]">
          ...
          <h2 className="font-serif text-5xl md:text-7xl leading-[1.05]">
            A fortress, <em>a story</em>, a horizon.
          </h2>
          <p className="mt-8 text-lg leading-relaxed opacity-90">
            Five centuries of Venetian stone watch over a sea so clear it
            forgets it has a bottom. Walk down to the port, step onto a boat,
            and the island is yours in fifteen minutes.
          </p>
        </div>
      </div>
    </section>
    ...
    <section id="location" className="py-24 md:py-40 px-6 md:px-16 max-w-7xl mx-auto">
      <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
        <div className="relative">
          <img
            src={breakfastImg}
            alt="Greek breakfast on a sunny terrace"
            loading="lazy"
            width={1200}
            height={1500}
        ...
        <div>
          ...
          <p className="mt-8 text-lg leading-relaxed text-muted-foreground max-w-md">
            A charming fishing village with traditional taverns, crystal-clear
            beaches, and the gateway to Spinalonga — all at your doorstep.
          </p>
          ...
          <a
            href="#"
            className="inline-block mt-12 text-sm uppercase tracking-[0.3em] text-primary border-b border-accent pb-1 hover:text-accent transition"
          >
            Discover Plaka →
          </a>
        </div>
  ...
  return (
    <section id="book" className="relative py-32 md:py-48 px-6 md:px-16 overflow-hidden bg-primary text-[oklch(0.97_0.012_85)]">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <a
          href="mailto:stay@athinavillas.gr"
          className="inline-block mt-12 bg-[oklch(0.97_0.012_85)] text-primary px-12 py-5 text-xs uppercase tracking-[0.3em] hover:bg-accent hover:text-primary-foreground transition"
        >
          Book Your Stay
        </a>
      </div>
...
function Footer() {
  return (
    <footer id="contact" className="bg-[oklch(0.18_0.02_220)] text-[oklch(0.85_0.01_85)] py-16 px-6 md:px-16">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          <p className="font-serif text-3xl text-[oklch(0.97_0.012_85)]">Athina <span className="text-accent">·</span> Villas</p>
        ...
        <div>
          <p className="text-[10px] uppercase tracking-[0.3em] text-accent mb-4">Follow</p>
          <p className="text-sm opacity-80">Instagram</p>
          <p className="text-sm opacity-80 mt-1">Booking.com</p>
        </div>
      </div>
